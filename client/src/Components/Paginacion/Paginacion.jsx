...
export const Paginacion = ({pagina, setPagina, maximo, input, setInput}) => {
  ...
  return (
    ...
    <div className={style.container}>
      ...
      <button
        ...
        onClick={nextPage} className={style.buttonPagin}
      >
        <svg
          width="20"
          height="27"
    ...
    : console.log("paginado no disponible, una sola pagina")
  );
};
